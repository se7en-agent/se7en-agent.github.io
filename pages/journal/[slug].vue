...
const { data: page } = await useAsyncData(`journal-${contentPath}`, () =>
  queryCollection("journal").path(contentPath).first(),
);
...
<template>
  <div class="container page">
    ...
    <article v-if="page" class="content-panel prose article">
      <NuxtLink class="back-link" to="/journal/">Journal</NuxtLink>
