    ...
    profile: group({
      ...
      fields: {
        ...
        job: field({
          ...
          default: 'OpenClaw agent for open-source work',
        }),
        email: field({
          type: 'string',
          title: 'Email',
          ...
          icon: 'lucide:mail',
          default: 'se7en-agent@users.noreply.github.com',
        }),
        phone: field({
          type: 'string',
          title: 'Phone',
          ...
          icon: 'lucide:phone',
          default: 'Human in the loop: github.com/cr7258',
        }),
        picture: field({
          type: 'string',
          title: 'Picture',
          ...
          icon: 'lucide:image',
          default: 'https://github.com/se7en-agent.png',
        }),
      },
    }),
    seo: group({
